...
CREATE PROCEDURE ADD_BOOK (IN isbn_in VARCHAR(20),IN title_in VARCHAR(50),IN author_in VARCHAR(50),IN about_in VARCHAR(2000),
						  ...
						  IN date_in  VARCHAR(20),IN copies_in INT(20), IN imagepath_in VARCHAR(50))
BEGIN
INSERT INTO books
(
...
(
	...
	(SELECT category_id FROM categories WHERE name = category_in), STR_TO_DATE(date_in,'%d-%M-%y'), imagepath_in
);
